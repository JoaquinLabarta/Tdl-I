    ...
    /*Implemente la biblioteca imath.h, la cual contiene funciones matem�ticas para enteros. La misma debe
    ...
    caso.
    h. int divisor (int x, int y) � Retorna 1 si y es m�ltiplo de x, 0 en otro
    caso.
